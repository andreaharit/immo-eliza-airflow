...
def clean(infile: str, outfile: str) -> None:
    ...
    # Heating is often too incomplete.
    ...
    # Rooms (around 72% missing) is covered by bathrooms and bedrooms numbers which are more complete 
    ...
    # Fields with usually too many NULLS > 50%
